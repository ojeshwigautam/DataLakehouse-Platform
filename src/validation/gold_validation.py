...
def validate_gold():
    ...
    try:
        ...
        validate_top_states()
        logger.info("✅ top_states")

        validate_delivery_summary()
        logger.info("✅ delivery_summary")

        save_validation_report(
            "gold", True, "All Gold datasets validated successfully."
        )

        logger.info("🎉 All Gold datasets validated successfully!")

    except Exception as e:

        save_validation_report("gold", False, str(e))
